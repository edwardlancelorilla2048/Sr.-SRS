...
def generate_random_inputs():
    ...
    "SpaceX’s New Year’s Eve launch of 21 Starlink smallsats including 13 Direct to Cell",
    ...
    "Could Yellowstone’s Huge Volcano Blow Again?",
    "The progression of basaltic–rhyolitic melt storage at Yellowstone Caldera",
    "Fossil record reveals 517 million-year-old predator-prey ‘arms race’",
    ...
    "Physics behind supra-thermal ions in burning plasma unlocked by China",
    ...
    "UVA Prof's Research to Boost Next-Gen Space Rockets",
    ...
    "SpaceX launches Thuraya 4 mission from Florida",
    ...
    "Northern Lights could be seen across UK on New Year’s Eve celebrations",
    "Erupting Sun May Have Sparked Cannibal CME Towards Earth",
    "Sun Releases Strong Solar Flare – Solar Cycle 25",
    ...
    "Southern Ocean Fossils Reveal Climate Impact on Deep-Sea Life",
    ...
    "CaMKIIβ key in transducing Ca²⁺ transients to initiate autophagosome formation",
    ...
    "New study makes astonishing discovery about tiny ocean creatures",
    "Scientists make stunning discovery after examining microscopic animal droppings",
    ...
    "A race to own the moon': Humans could soon be seen mining Earth's only natural satellite",
    ...
    "Scientists carve textures onto microscopic diamonds",
    ...
    "NASA about to confirm alien life? It’s 3 billion km away, and there’s a mission on its way",
    ...
    "NASA spots anomaly in Earth’s magnetic field",
    ...
    "Lumbar Spondylolysis After Posterior Corrective Fusion for Adolescent Idiopathic Scoliosis",
    ...
    "Zoom Into The Milky Way's Sagittarius A* Black Hole",
    ...
    "Scalable synthesis of Cu-cluster catalysts via spark ablation for the electrochemical conversion of CO",
    ...
    "Human Brain Cells Have More Upregulated Genes Than Chimps",
    ...
    "Behind The Scenes Of A SpaceX Falcon Heavy Launch - Hughes Jupiter 3",
    "NASA Satellite Reveals Never-Before-Seen Details of the Ocean Floor",
    "'One of the most important species for science': How the humble fruit fly transformed four fields of research",
    "Fruit Flies: Micro Scientists Transforming Global Research",
    "Century-Old Challenge Of “Atomic Diffraction” Finally Solved Thanks To Graphene",
    "Saturn's Rings Had Strange Seasonal Spokes - Hubble To Study",
